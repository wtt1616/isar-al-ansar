...
async function importHartaModal(csvFilePath) {
  let connection;
...
// Main execution
const csvFile = process.argv[2] || path.join(__dirname, 'harta-modal-data.csv');

if (!fs.existsSync(csvFile)) {
  console.error(`Error: CSV file not found: ${csvFile}`);
  console.log('\nUsage: node import-harta-modal.js [csv-file-path]');
  console.log('Example: node import-harta-modal.js harta-modal-data.csv');
  process.exit(1);
}

importHartaModal(csvFile);
