    ...
    <>
      ...
      <div className="container mt-4">
        <div className="no-print mb-3">
          <button className="btn btn-secondary me-2" onClick={() => router.push('/inventory')}>
            &larr; Kembali
          </button>
        ...
        {loading ? (
          ...
          <div className="report-content">
            ...
            <div className="text-center mb-4">
              <h3 className="mb-1">LAPORAN INVENTORI</h3>
            ...
            <div className="mb-4">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="mb-0">Jumlah Inventori: <strong>{inventory.length}</strong> item</p>
                </div>
              </div>
            </div>
                  ...
                  {inventory.length === 0 ? (
                    <tr>
                      <td colSpan={4} className="text-center text-muted">
                        Tiada inventori untuk dipaparkan
                      </td>
                    </tr>
                  ) : (
