...
export async function POST(request: NextRequest) {
  try {
    ...
    if (action === 'auto_generate') {
      ...
      const getYearlyPembayaranPembangunan = async (year: number) => {
      ...
      const currentYearSums = await getYearlyPembayaranPembangunan(targetYear);
      const previousYearSums = await getYearlyPembayaranPembangunan(previousYear);
