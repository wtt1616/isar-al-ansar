...
export default function NotaButiranBaki31DisReportPage() {
    ...
    <div className="container py-4">
      ...
      <div className="d-print-none mb-4">
        <div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
          <h4 className="mb-0">Laporan Nota Butiran Baki 31 Disember</h4>
      ...
      {data && (
        <div className="print-container">
          ...
          <div className="text-center mb-4">
            <h5 className="fw-bold text-decoration-underline">NOTA BUTIRAN BAKI 31 DISEMBER</h5>
          </div>

          {/* Section 1: Baki Wang Di Bank */}
          <div className="mb-4">
            <h6 className="fw-bold">1. Baki Semua Wang Di Bank Pada 31 Disember</h6>
          ...
          <div className="mb-4">
            <h6 className="fw-bold">2. Baki Pelaburan Pada 31 Disember</h6>
            <table className="table table-bordered" style={{ fontSize: '12px' }}>
              <thead>
                <tr className="table-light">
                  <th style={{ width: '50px' }}>Bil</th>
          ...
          <div className="mb-4">
            <h6 className="fw-bold">3. Baki Deposit Di bayar Pada 31 Disember</h6>
            <table className="table table-bordered" style={{ fontSize: '12px' }}>
              <thead>
                <tr className="table-light">
                  <th style={{ width: '50px' }}>Bil</th>
            ...
            <table className="table table-bordered" style={{ fontSize: '12px' }}>
              <tbody>
                <tr className="table-dark fw-bold">
                  <td>JUMLAH KESELURUHAN BAKI 31 DISEMBER {tahun}</td>
