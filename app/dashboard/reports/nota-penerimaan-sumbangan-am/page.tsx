...
export default function NotaPenerimaanSumbanganAmReportPage() {
    ...
    <div className="container py-4">
      ...
      <div className="d-print-none mb-4">
        <div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
          <h4 className="mb-0">Laporan Nota Butiran Penerimaan Sumbangan Am</h4>
      ...
      {data && (
        <div className="print-container">
          {/* Section Header */}
          <div className="mb-4">
            <h6 className="fw-bold">4. Sumbangan Am</h6>
            <table className="table table-bordered" style={{ fontSize: '12px' }}>
              <thead>
                <tr className="table-light">
                  ...
                  <th className="text-center" style={{ width: '150px' }}>Tahun sebelum<br />RM</th>
                </tr>
              </thead>
              <tbody>
                {data.data.length === 0 ? (
